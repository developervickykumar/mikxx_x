...
<head>
    ...
    <title>Ai Suggestion Popup - Code Generator</title>
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <h1 class="page-title">Ai Suggestion Popup</h1>
            <div class="content-section">
                
            <div class="content-section">
                <h2>Overview</h2>
                <p>This is the Ai Suggestion Popup page. Content will be added here.</p>
            </div>
            <div class="content-section">
                <h2>Details</h2>
