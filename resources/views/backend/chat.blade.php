        ...
        <div class="p-3 px-4 border-bottom">
            <div class="d-flex align-items-start ">
                <div class="flex-shrink-0 me-3 align-self-center">
                    <img src="build/images/users/avatar-1.jpg" class="avatar-sm rounded-circle" alt="">
                </div>

                <div class="flex-grow-1">
                    <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Shawn <i
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">Jennie
                                                    Sherlock</h5>
                                ...
                                <li class="unread">
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">Stacie
                                                    Dube</h5>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">Katie
                                                    Olson</h5>
                                                <p class="text-truncate mb-0">This theme is awesome!
                                                </p>
                                            </div>
                                            <div class="flex-shrink-0">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">Marshall
                                                    Wilson</h5>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">James
                                                    Lee</h5>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">Ronald
                                                    Tucker</h5>
                                                <p class="text-truncate mb-0">Nice to meet you</p>
                                            </div>
                                            <div class="flex-shrink-0">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-1">Dennis
                                                    Stewart</h5>
                                                <p class="text-truncate mb-0">Nice to meet you</p>
                                            </div>
                                            <div class="flex-shrink-0">
                                    ...
                                    <ul class="list-inline message-img mt-3  mb-0">
                                        <li class="list-inline-item message-img-list">
                                            <a class="d-inline-block m-1" href="">
                                                <img src="build/images/small/img-1.jpg" alt=""
