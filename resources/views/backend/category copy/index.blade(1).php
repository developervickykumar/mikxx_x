                            ...
                            <div class="category-info">
                                ...
                                <div class="category-details">
                                    ...
                                    'categoryId' => $categorie->id
                                        ...
                                        <button type="button" class="btn btn-soft-success action-button edit-page"
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <ul class="nav nav-tabs" id="dynamicTabs">
                              ...
                              <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-view">Blade</button></li>
                              <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-model">Model</button></li>
                            </ul>
                            
                            <div class="tab-content mt-2">
                              <div class="tab-pane fade show active" id="tab-route"><div id="routeEditor" style="height:300px"></div></div>
                              <div class="tab-pane fade" id="tab-controller"><div id="controllerEditor" style="height:300px"></div></div>
                              <div class="tab-pane fade" id="tab-view"><div id="viewEditor" style="height:300px"></div></div>
                              <div class="tab-pane fade" id="tab-model"><div id="modelEditor" style="height:300px"></div></div>
                            </div>
                            ...
                            <!--  <input type="text" class="form-control" id="pagePathInput">-->
                            <!--</div>-->
                            <!--<div class="mb-3">-->
                            <!--  <label>Controller Method</label>-->
                            <!--  <input type="text" class="form-control" id="controllerMethodInput">-->
                            <!--</div>-->
                            <!--<div class="mb-3">-->
                            <!--  <label>Blade View Path</label>-->
                            <!--  <input type="text" class="form-control" id="bladePathInput">-->
                            <!--</div>-->
                            <!--<div class="mb-3">-->
                            <!--  <label>Page Content</label>-->
                            <!--  <div id="bladeEditor" style="height: 400px;"></div>-->
                            <!--</div>-->
                          </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    require(['vs/editor/editor.main'], function () {
        editor = monaco.editor.create(document.getElementById('bladeEditor'), {
            value: '',
            language: 'php',
            theme: 'vs-dark'
        });
...
//     $('#pagePathInput').val(path);
    
//     const cleanPath = path.split('/').filter(Boolean).pop();
//     const fullPath = `resources/views/dynamic/templates/${cleanPath}.blade.php`;

//     $('#bladePathInput').val(fullPath);
//     $('#controllerMethodInput').val(`DynamicPageController@render`);

//     axios.get('/admin/file-manager/load', {
//         params: { path: fullPath }
//     })
//     .then(res => {
//         console.log('File content loaded from backend:', res.data.content);
//         editor.setValue(res.data.content || '');

//         // 🛠️ Force Monaco to layout in case it was invisible at init
...
//     const filePath = document.getElementById('bladePathInput').value;
//     const content = editor.getValue();

//     axios.post('/admin/file-manager/save', {
//         path: filePath,
//         content: content
...
let routeEditor, controllerEditor, viewEditor, modelEditor;

require(['vs/editor/editor.main'], function () {
  routeEditor = monaco.editor.create(document.getElementById('routeEditor'), {
    value: `Route::get('/your-path', [YourController::class, 'method']);`,
    language: 'php', theme: 'vs-dark'
  });
  controllerEditor = monaco.editor.create(document.getElementById('controllerEditor'), {
    value: `public function method() { return view('dynamic.pages.slug'); }`,
    language: 'php', theme: 'vs-dark'
  });
  viewEditor = monaco.editor.create(document.getElementById('viewEditor'), {
    value: `@extends('layouts.master')

@section('content')
    <h1>Your Dynamic Page</h1>
@endsection
`,
    language: 'html', theme: 'vs-dark'
  });
  modelEditor = monaco.editor.create(document.getElementById('modelEditor'), {
    value: `class YourModel extends Model { protected $table = 'your_table'; }`,
    language: 'php', theme: 'vs-dark'
  });
});
...
function saveDynamicPageFiles() {
  ...
  axios.post('/admin/dynamic-page/save', {
    slug: slug,
    route: routeEditor.getValue(),
    controller: controllerEditor.getValue(),
