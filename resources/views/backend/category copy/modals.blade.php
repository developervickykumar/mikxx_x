                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select name="functionality" id="edit_functionality_select" class="form-control">
                                                ...
                                                <optgroup label="Dynamic Element Types">
                                                    ...
                                                    <option value="Checkbox Column Table"
                                                        data-cond="checkbox-column-table">Checkbox Column Table</option>
                                                    <option value="Multiple Text Fields"
                                                        data-cond="multiple-text-fields">Multiple Text Fields</option>
                                                    ...
                                                    <option value="Scrollable Description"
                                                        data-cond="scrollable-description">Scrollable Description
                                                    </option>
