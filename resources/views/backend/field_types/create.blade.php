                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('field-types.store') }}">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('component_name') is-invalid @enderror" 
                                           id="component_name" name="component_name" value="{{ old('component_name') }}" required
                                           onkeyup="updatePreview()">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('default_config') is-invalid @enderror" 
                                              ...
                                              onkeyup="updatePreview()">{{ old('default_config') ? json_encode(old('default_config'), JSON_PRETTY_PRINT) : '{}' }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('validation_rules') is-invalid @enderror" 
                                              ...
                                              onkeyup="updatePreview()">{{ old('validation_rules') ? json_encode(old('validation_rules'), JSON_PRETTY_PRINT) : '{}' }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('supported_attributes') is-invalid @enderror" 
                                              ...
                                              onkeyup="updatePreview()">{{ old('supported_attributes') ? json_encode(old('supported_attributes'), JSON_PRETTY_PRINT) : '[]' }}</textarea>
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                           {{ old('is_active', true) ? 'checked' : '' }} onChange="updatePreview()">
                                ...
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body">
                                        <div id="preview-container" class="border p-3 rounded mb-3">
                                            <p class="text-muted">Configure the field type to see preview</p>
                                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">Create Field Type</button>
                        </div>
                    </form>
                </div>
            </div>
