...
.copyable-block:hover {
  outline: 1px dashed #4d42c3;
  position: relative;
}
</style>


<div class="row copyable-block" id="page-student-form">
    <div class="col-xl-9 col-lg-8">
        ...
        <div class="tab-content  copyable-block" id="profile-section">
            @foreach($profileTabs as $index => $tab)
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  copyButton.style.background = "#4d42c3";
  ...
  document.querySelectorAll(".copyable-block").forEach((el) => {
    ...
    el.addEventListener("mouseenter", (e) => {
      ...
      copyButton.style.left = window.scrollX + rect.right - 80 + "px";
