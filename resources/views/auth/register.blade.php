                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Get your free Mikxx account now.</p>
                                        </div>
                                        

                                        <form method="POST" action="" class="needs-validation mt-4 pt-2" novalidate>
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="password_confirmation" type="password" placeholder="Confirm Password"
                                                    class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password">
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0">By registering you agree to the Mikxx <a href="#" class="text-primary">Terms of Use</a></p>
                                            </div>
                                            <div class="mb-3">
